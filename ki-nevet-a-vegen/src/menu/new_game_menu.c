...
menu_state draw_new_game_menu(uint32_t window_width, uint32_t window_height, void* menu_data_ext)
{
	...
	item_info game_name_field = ui_draw_text_field(menu_data->buffer, 250.0f, 50.0f,
	...
	item_info dice_count = ui_draw_spinner(&menu_data->dice.dice_count, 1, 4, 117.5f, 50.0f,
		item_placement_center, item_placement_beg, -67.5f, y,
		vec4_create(0.87f, 0.74f, 0.54f, 1.0f), vec4_create(0.92f, 0.79f, 0.59f, 1.0f));
	item_info dice_sides = ui_draw_spinner(&menu_data->dice.sides, 4, 20, 117.5f, 50.0f,
		item_placement_center, item_placement_beg, 67.5f, y,
		vec4_create(0.87f, 0.74f, 0.54f, 1.0f), vec4_create(0.92f, 0.79f, 0.59f, 1.0f));
