...
{
	piece_t pieces[40]; /* Pieces on the board */
	game_object_index_t game_object; /* Board object in the scene */
	game_object_index_t piece_objects[4 * 4]; /* Piece objects in the scene */
