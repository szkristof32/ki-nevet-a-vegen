...
{
	size_t size; /* Holds the capacity of the arena allocator in bytes */
	void* allocation; /* The pointer to the allocation */
	void* pointer; /* Pointer to the remaining block of the pool */
} arena_allocator_t;
