...
/**
 * Returns the minimum of the two vectors per component
 * 
 * @param a, b The vectors to compare
 * 
 * @returns A 4 component vector where each component is the min of the respective components of `a` and `b`
 */
vec4 vec4_min(vec4 a, vec4 b);
/**
 * Returns the maximum of the two vectors per component
 *
 * @param a, b The vectors to compare
 *
 * @returns A 4 component vector where each component is the max of the respective components of `a` and `b`
 */
